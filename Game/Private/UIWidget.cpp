...
UIWidget::UIWidget(ConstructorParam&& constructorParam)
	: UIWidget(
...
UIWidget::UIWidget(const ConstructorParam& constructorParam)
	: UIWidget(
		constructorParam.updateOrder,
		constructorParam.bIsActive,
		constructorParam.center,
...
UIWidget::UIWidget(ConstructorParamWithoutBackground&& constructorParam)
	: UIWidget(
		constructorParam.updateOrder,
		constructorParam.bIsActive,
		constructorParam.center,
...
UIWidget::UIWidget(const ConstructorParamWithoutBackground& constructorParam)
	: UIWidget(
		constructorParam.updateOrder,
		constructorParam.bIsActive,
		constructorParam.center,
...
UIWidget::UIWidget(ConstructorParamWithoutText&& constructorParam)
	: UIWidget(
		constructorParam.updateOrder,
		constructorParam.bIsActive,
		constructorParam.center,
...
UIWidget::UIWidget(const ConstructorParamWithoutText& constructorParam)
	: UIWidget(
		constructorParam.updateOrder,
		constructorParam.bIsActive,
		constructorParam.center,
...
void UIWidget::Tick(float deltaSeconds)
{
...
void UIWidget::DrawBackgroundUI(FixCamera* fixCamera)
{
...
void UIWidget::DrawTextUI(FixCamera* fixCamera)
{
