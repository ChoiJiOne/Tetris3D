...
HRESULT TextureNoEffectShader::CreateVertexShaderFromFile(ID3D11Device* device, const std::wstring& sourcePath, ID3DBlob** vertexShaderSource, ID3D11VertexShader** vertexShader)
{
...
HRESULT TextureNoEffectShader::CreatePixelShaderFromFile(ID3D11Device* device, const std::wstring& sourcePath, ID3DBlob** pixelShaderSource, ID3D11PixelShader** pixelShader)
{
...
HRESULT TextureNoEffectShader::CreateInputLayout(ID3D11Device* device, ID3DBlob* vertexShaderSource, const std::vector<D3D11_INPUT_ELEMENT_DESC>& inputLayoutElements, ID3D11InputLayout** inputLayout)
{
