...
HRESULT EffectShader::CreateLinearTextureSampler(ID3D11Device* device, ID3D11SamplerState** outLinearTextureSampler)
{
	...
	return device->CreateSamplerState(&textureSamplerDesc, outLinearTextureSampler);
}
